...
public class AccountResource {
    ...
    public ResponseEntity registerAccount(@Valid @RequestBody ManagedUserVM managedUserVM) {
        String message = managedUserVM.toString();
        log.debug(message);
                ...
                .orElseGet(() -> {
                    User user = userService
                        .createUser(managedUserVM.getLogin(), managedUserVM.getPassword(),
                            ...
                            managedUserVM.getDegree(), managedUserVM.getSemester(), managedUserVM.getFaculty(), managedUserVM.getUniversity(), managedUserVM.getBirthday()
        ...
        return userRepository
            ...
            .map(u -> {
                userService.updateUser(userDTO.getFirstName(), userDTO.getLastName(), userDTO.getEmail(),
                    userDTO.getLangKey(), userDTO.getImageUrl(), userDTO.getDegree(), userDTO.getSemester(),
                    userDTO.getFaculty(), userDTO.getUniversity(), userDTO.getBirthday());
