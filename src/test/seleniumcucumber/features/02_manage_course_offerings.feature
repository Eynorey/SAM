Feature: Manage Courses
    ...
    Scenario: Create course, Read it
        ...
        #create course
        When I click on element having class "hidden-xs" and text "Create new Course"
        ...
        And I wait for 1 sec
        Then element having xpath "/html/body/div[3]/div[1]/div/dl/dd[1]/span" should have text as "Test Title"
        Then element having xpath "/html/body/div[3]/div[1]/div/dl/dd[2]/span" should have text as "Test Description"
        Then element having xpath "/html/body/div[3]/div[1]/div/dl/dd[3]/span" should have text as "Nov 1, 2016 8:00:00 AM"
        Then element having xpath "/html/body/div[3]/div[1]/div/dl/dd[4]/span" should have text as "Nov 1, 2016 5:00:00 PM"
        Then element having xpath "/html/body/div[3]/div[1]/div/dl/dd[5]/span" should have text as "Test location"
    ...
    Scenario: Update course, Read it
        ...
        And I click on element having class "glyphicon-eye-open"
        And I wait for 1 sec
        Then element having xpath "/html/body/div[3]/div[1]/div/dl/dd[1]/span" should have text as "Edited Title"
        Then element having xpath "/html/body/div[3]/div[1]/div/dl/dd[2]/span" should have text as "Edited Description"
        Then element having xpath "/html/body/div[3]/div[1]/div/dl/dd[3]/span" should have text as "Nov 1, 2016 8:00:00 AM"
        Then element having xpath "/html/body/div[3]/div[1]/div/dl/dd[4]/span" should have text as "Nov 1, 2016 5:00:00 PM"
        Then element having xpath "/html/body/div[3]/div[1]/div/dl/dd[5]/span" should have text as "Test location"
    ...
    Scenario: Delete course
        ...
        And I wait for 1 sec
        #see confirmation
        Then element having xpath "/html/body/div[3]/div[1]/div/jhi-alert/div/div/div/div/pre" should have partial text as "A course is deleted"
