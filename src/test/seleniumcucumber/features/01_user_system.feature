Feature: register
    ...
    Scenario: invalid email
        ...
        And I wait for 1 sec
        Then element having xpath "/html/body/div[3]/div[1]/div/div/div[2]/form/div[2]/div/p[2]" should have text as "Your e-mail is invalid."
    ...
    Scenario: Password confirmation does not match
        ...
        And I wait for 1 sec
        Then element having xpath "/html/body/div[3]/div[1]/div/div/div[1]/div[5]" should have text as "The password and its confirmation do not match!"
    ...
    Scenario: Registration successful
        ...
        Then element having xpath "/html/body/div[3]/div[1]/div/div/div[2]/h1" should have partial text as "Welcome"
