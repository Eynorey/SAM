...
class CourseGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Course entity")
        ...
        .repeat(2) {
            ...
            .post("/api/courses")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "title":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "start":"2020-01-01T00:00:00.000Z", "end":"2020-01-01T00:00:00.000Z", "location":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
