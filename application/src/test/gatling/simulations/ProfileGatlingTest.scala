...
class ProfileGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Profile entity")
        ...
        .repeat(2) {
            ...
            .post("/api/profiles")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "credibility":"0", "credits":null, "degree":"SAMPLE_TEXT", "semester":"0", "faculty":"SAMPLE_TEXT", "university":"SAMPLE_TEXT", "birthday":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
